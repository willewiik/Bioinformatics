...
calc_seq_stats <- function(all_seq, index_seq) {
 ...
 base <- base.freq(structure(all_seq[[index_seq]], class = "DNAbin"))
 GC_content <- base["g"] +  base["c"]
 ...
 print(paste0("AT content for ", names(all_seq)[index_seq],
              ": ",round(AT_content,3)))
 
}

# True lizard sequences
...
```{r}
# True lizard sequence 1
calc_seq_stats(all_seq = true_sequences, index_seq = 1)
```

```{r}
# Simulate lizard sequence 1
